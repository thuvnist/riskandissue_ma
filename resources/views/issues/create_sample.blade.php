    ...
    <div class="container-fluid">
        <div class="row">
            <div class="box-info box">
                <div class="box-body">
                    <form action="{{ route('issues.store_sample') }}" method="POST">
                        @csrf
                        <div class="form-group text-right">
                            <button type="submit" class="btn btn-primary">Lưu</button>
                            <a href="{{ route('issues.sample') }}" class="btn btn-default">Hủy</a>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="">Những nhân viên có quyền xem mẫu này:</label>
                                    <div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            <td>Tiêu đề<input type="hidden" value="Tiêu đề" name="column_name[]"></td>
                                            <td>Tiêu đề<input type="hidden" value="Tiêu đề" name="column_desc[]"></td>
                                            <td>text<input type="hidden" value="text" name="column_type[]"></td>
                                            <td>có<input type="hidden" value="có" name="column_required[]"></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td>Trạng thái<input type="hidden" value="Trạng thái" name="column_name[]"></td>
                                            <td>Trạng thái<input type="hidden" value="Trạng thái" name="column_desc[]"></td>
                                            <td>select<input type="hidden" value="select" name="column_type[]"></td>
                                            <td>có<input type="hidden" value="có" name="column_required[]"></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td>Độ ưu tiên<input type="hidden" value="Độ ưu tiên" name="column_name[]"></td>
                                            <td>Độ ưu tiên<input type="hidden" value="Độ ưu tiên" name="column_desc[]"></td>
                                            <td>select<input type="hidden" value="select" name="column_type[]"></td>
                                            <td>không<input type="hidden" value="không" name="column_required[]"></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td>Mô tả<input type="hidden" value="Mô tả" name="column_name[]"></td>
                                            <td>Mô tả<input type="hidden" value="Mô tả" name="column_desc[]"></td>
                                            <td>text<input type="hidden" value="text" name="column_type[]"></td>
                                            <td>không<input type="hidden" value="không" name="column_required[]"></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td>Người giải quyết<input type="hidden" value="Người thực hiện" name="column_name[]"></td>
                                            <td>Người giải quyết<input type="hidden" value="Người thực hiện" name="column_desc[]"></td>
                                            <td>select<input type="hidden" value="select" name="column_type[]"></td>
                                            <td>không<input type="hidden" value="không" name="column_required[]"></td>
                                            <td></td>
                                        </tr>
