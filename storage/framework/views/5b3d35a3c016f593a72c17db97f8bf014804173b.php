                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-4 im-flex im-flex-center">
                            <div class="im-box im-flex im-flex-column">
                                ...
                                <h5 class="text-center">Số lượng: 2</h5>
                                <h5 class="text-center">Số lượng: 2</h5>
                            </div>
                        </div>
                        <div class="col-md-4 im-flex im-flex-center">
                            <div class="im-box im-flex im-flex-column">
                                <div class="im-flex">
                                    <div style="width: 80%; border: 1px #000000 solid; background: blue; margin-top: 5px;">
                                        <h5 style="color: white">
                                            Báo cáo công việc không có issue
                                        </h5>
                                    </div>
                                    <div style="width: 20%; font-size: 20px;" class="im-flex im-flex-center">
                                        <i class="fa fa-ellipsis-v"></i>
                        ...
                        <div class="col-md-4 im-flex im-flex-center im-mt">
                            <div class="im-box im-flex im-flex-column">
                                <div class="im-flex">
                                    <div style="width: 80%; border: 1px #000000 solid; background: blue; margin-top: 5px;">
                                        <h5 style="color: white">
                                            Báo cáo KPI có issue
                                        </h5>
                                    </div>
                                    <div style="width: 20%; font-size: 20px;" class="im-flex im-flex-center">
                                        <i class="fa fa-ellipsis-v"></i>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\issue-management\resources\views/reports/report.blade.php ENDPATH**/ ?>