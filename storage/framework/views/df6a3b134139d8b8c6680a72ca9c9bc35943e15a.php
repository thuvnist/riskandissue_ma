...
<div class="tab-content mt-10">
    <div id="myModal1" class="tab-pane fade in active">
        <div class="row">
            <form action="<?php echo e(route('tasks.issues.update', [$task->id, $issue->id])); ?>" class="form-horizontal" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\issue-management\resources\views/projects/issue_defend.blade.php ENDPATH**/ ?>