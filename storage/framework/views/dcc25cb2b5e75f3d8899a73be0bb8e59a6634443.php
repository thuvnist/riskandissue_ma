                ...
                <div class="box-body">
                    <form action="<?php echo e(route('templates.store')); ?>" method="POST">
                        ...
                        <div class="form-group text-right">
                            ...
                            <a href="<?php echo e(route('templates.index')); ?>" class="btn btn-default">Hủy</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\issue-management\resources\views/template/create.blade.php ENDPATH**/ ?>