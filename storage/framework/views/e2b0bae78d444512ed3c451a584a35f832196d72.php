            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(route('tasks.issues_create', 1)); ?>" class="btn btn-primary">Issue</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\issue-management\resources\views/tasks/edit.blade.php ENDPATH**/ ?>