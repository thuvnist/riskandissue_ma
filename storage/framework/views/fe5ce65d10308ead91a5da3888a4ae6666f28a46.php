                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control priority-select-save-inline" data-href="" name="priority" id="">
                                    <?php $__currentLoopData = $priorities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyPr => $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($risk['priority'] == $keyPr): ?> selected <?php endif; ?> value="<?php echo e($keyPr); ?>"><?php echo e($priority); ?></option>
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control status-select-save-inline" name="status" id="">
                                    <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyPr => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($risk['status'] == $keyPr): ?> selected <?php endif; ?> value="<?php echo e($keyPr); ?>"><?php echo e($status); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                ...
                <div class="box-body">
                    ...
                    <div class="tab-content mt-10">
                        ...
                        <div id="menu6" class="tab-pane fade">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <?php if(!empty($risk['defend'])): ?>
                                        <?php $__currentLoopData = $risk['defend']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyPr => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($keyPr + 1); ?></td>
                            ...
                            <button data-risk="<?php echo e($riskKey); ?>" data-task="<?php echo e($task->id); ?>" data-href="<?php echo e(route('tasks.risks.defend')); ?>" class="btn btn-primary js-btn-risk-defend mt-20 mb-20">Thêm chiến lược phòng ngừa</button>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\issue-management-20200111T033215Z-001\issue-management\resources\views/risks/detail.blade.php ENDPATH**/ ?>